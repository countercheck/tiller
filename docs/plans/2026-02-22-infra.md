...
- Create: `infra/azure/clients/violet-moose-lantern.tfvars`
...
**Step 2: Create clients/violet-moose-lantern.tfvars**
...
```bash
git add infra/azure/main.tf infra/azure/clients/violet-moose-lantern.tfvars
git commit -m "feat: add root main.tf and violet-moose-lantern client tfvars"
```
